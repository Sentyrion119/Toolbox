...
export async function generateMetadata({
  ...
  return {
    title: `${t.togglePdfToImg} / ${t.toggleImgToPdf}`,
    description: t.seoBody.slice(0, 160),
    alternates: {
      languages: {
        en: '/en/tools/pdf-converter',
        fr: '/fr/tools/pdf-converter',
      },
    },
  };
}

const PdfToolWrapper = dynamic(() => import('@/components/tools/PdfToolWrapper'), {
  ssr: false,
  loading: () => (
...
export default function PdfConverterPage({ params }: { params: { lang: string } }) {
  ...
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: `${t.togglePdfToImg} / ${t.toggleImgToPdf}`,
    url: `https://quicktools.vercel.app/${lang}/tools/pdf-converter`,

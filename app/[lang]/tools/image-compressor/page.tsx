...
export async function generateMetadata({
  ...
  const t = getDictionary(params.lang as Locale).tools.imageCompressor;
  return {
    title: t.h1,
...
export default function ImageCompressorPage({ params }: { params: { lang: string } }) {
  ...
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: t.h1,
    url: `https://quicktools.vercel.app/${lang}/tools/image-compressor`,
    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        <div className="max-w-2xl mx-auto px-6">
          <nav className="pt-8 pb-2 flex items-center justify-between">
